...
export default function ContactForm() {
    ...
    return (
        <div className={`bg-[#1a1a1a] p-8 rounded-2xl shadow-lg ${marope.className} w-fit mx-auto`}>
            <h2 className={`${spaceGrotesk.className} text-3xl font-bold mb-8 text-white`}>
                Fala comigo!
            </h2>

            <form onSubmit={handleSubmit} className="space-y-5 w-auto h-auto">
                <div className= "w-auto h-auto mr-9" >
                    ...
                    <div className="pb-2">
                        ...
                        <textarea id="message" rows={5} value={formData.message} onChange={handleChange} className={`${inputClassName} resize-none`} required placeholder="Dávidas, Propostas, Sugestões, Elogios..." />
                    </div>
