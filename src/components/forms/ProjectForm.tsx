  ...
  if (!formData) {
    return (
      <div className="text-red-400">
        Erro: dados do formulário não carregados
      </div>
    );
  }
    ...
    <div className="bg-[#1a1a1a] rounded-lg shadow-2xl p-8 flex-shrink-0">
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div
            className={`${marope.className} flex flex-col justify-between pr-8`}
          >
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Tamanho máximo: {MAX_FILE_SIZE / (1024 * 1024)}MB • Formatos:
                  PNG, JPEG, WebP
                  <br />
